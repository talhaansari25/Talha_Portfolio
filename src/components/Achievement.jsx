              ...
              <div className="card-wrapper swiper-wrapper">
                ...
                <div className="card swiper-slide">
                  ...
                  <div className="card-content">
                    ...
                    <div className="button-wrapper"><a href="https://www.linkedin.com/posts/talha-ansari-22189b1bb_sih2024-smartindiahackathon-innovation-activity-7275529423381024768-VbLR?utm_source=share&utm_medium=member_desktop&rcm=ACoAADM19HkB2MGyj4JSCzp0eQM9bjQCf7j6ny4"
                      target="_blank"
                ...
                <div className="card swiper-slide">
                  <div className="image-content">
                    <div className="card-image">
                      <img src="images/nu.jpg" alt="" className="card-img" />
                    </div>
                  </div>
                  <div className="card-content">
                    <h2 className="name">DebugOn X IIT Delhi</h2>
                    <p className="description">
                      Finalist at DebugOn X Edc IIT Delhi with ONDC under Ministry of Industry and Internal Trade.
                    </p>
                    <div className="button-wrapper">
